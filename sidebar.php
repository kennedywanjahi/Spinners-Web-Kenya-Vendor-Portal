    ...
    <nav id="sidebar">
        ...
        <div class="left-custom-menu-adp-wrap">
            <ul class="nav navbar-nav left-sidebar-menu-pro">
              ...
              <li class="nav-item"><a href="vsummary.php" ><i class="fa big-icon fa-calendar-times"></i> <span class="mini-dn"> Monthly Summaries</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
              </li>
            </li>
        ...
        <li class="nav-item"><a href="gssummaries.php" ><i class="fas big-icon fa-calendar-week"></i> <span class="mini-dn">GS Summaries</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
        </li>
